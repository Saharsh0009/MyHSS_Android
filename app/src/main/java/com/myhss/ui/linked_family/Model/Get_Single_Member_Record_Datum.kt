...
class Get_Single_Member_Record_Datum {
    ...
    @Expose
    var dateOfFirstAidQualification: String? = null
    ...
    @Expose
    var shakha_id: String? = null

    @SerializedName("vibhag_id")
    @Expose
    var vibhag_id: String? = null

    @SerializedName("nagar_id")
    @Expose
    var nagar_id: String? = null
}