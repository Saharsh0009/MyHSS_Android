package com.myhss.ui.SanghSandesh
...
//    lateinit var suchana_cancel_layout: RelativeLayout
    ...
    private var sangh_sandesh_adapter: SanghSandeshAdapter? = null
...
//        suchana_cancel_layout = findViewById(R.id.suchana_cancel_layout)
        ...
        mLayoutManager = LinearLayoutManager(this@SanghSandeshActivity)
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    if (response.body()?.status!!) {
                        ...
                        try {
                            ...
                            mStringList.add("Sangh Mail")
                            mStringList.add("Sangh Sandesh")
...
//                        Functions.displayMessage(this@SanghSandeshActivity,response.body()?.message)
//                        Functions.showAlertMessageWithOK(
//                            this@SanghSandeshActivity, "",
////                        "Message",
