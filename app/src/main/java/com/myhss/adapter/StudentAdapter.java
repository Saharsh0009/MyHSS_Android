...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.ViewHolder> {
    ...
    public List<Datum> studentList;
    private Context context;

    public StudentAdapter(Context context, List<Datum> lstStudent) {
...
//        this.onItemClick = onItemCheckListener;
    ...
    interface OnItemCheckListener {
        void onItemCheck(Datum item);
        void onItemUncheck(Datum item);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (studentList != null) {
            ...
            holder.recycler_text_view.setText(studentList.get(position).getFirstName().toUpperCase()+ " " +
                    studentList.get(position).getLastName().toUpperCase());
           ...
           //this also works...!
            holder.recycler_checkbox.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View view) {
                    ...
                    Datum stakeHolder = (Datum) cb.getTag();
                    stakeHolder.setSelected(cb.isChecked());
                    studentList.get(position).setSelected(cb.isChecked());

                    Toast.makeText(view.getContext(),
                            "Clicked on Checkbox: " + studentList.get(position).getFirstName() + " is "
