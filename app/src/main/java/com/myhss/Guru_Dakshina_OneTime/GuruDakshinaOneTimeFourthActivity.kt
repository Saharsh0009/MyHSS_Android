...
class GuruDakshinaOneTimeFourthActivity() : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sessionManager.firebaseAnalytics.setUserProperty("OneTimeDakshinaStep4VC", "GuruDakshinaOneTimeFourthActivity")
        ...
        next_layout.setOnClickListener {
            if (edit_card_number.text.toString().isEmpty()) {
                ...
                Snackbar.make(rootLayout, "Please Enter Card Holder Name", Snackbar.LENGTH_SHORT)
                    .show()
            } else {
...
//            var res = edit_card_number.text.toString().replace("[^0-9]".toRegex(), "")   For Replace use
    ...
    private fun myDonate(
        ...
        val pd =
            CustomProgressBar(this@GuruDakshinaOneTimeFourthActivity)
        pd.show()
            ...
            override fun onResponse(
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    if (response.body()?.status!!) {
                        ...
                        val alertBuilder =
                            AlertDialog.Builder(this@GuruDakshinaOneTimeFourthActivity) // , R.style.dialog_custom
                        ...
                        Functions.displayMessage(this@GuruDakshinaOneTimeFourthActivity,response.body()?.message)
