...
public class GoogleCalendar extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private void createWeddingAnnniversaryEvent(Response resp, String calendarId, Calendar mService) {
        ...
        EventDateTime start = new EventDateTime()
                .setDateTime(Functions.dateFormatGCalendar(resp.getWEDDINGANNIVERSARY(), 10, 00))//10AM time to start
                .setTimeZone(TimeZone.getDefault().getID());
        event.setStart(start);

        EventDateTime end = new EventDateTime()
                .setDateTime(Functions.dateFormatGCalendar(resp.getWEDDINGANNIVERSARY(), 10, 11))//10AM time to end
                .setTimeZone(TimeZone.getDefault().getID());
        event.setEnd(end);
    ...
    private void createBirthdayEvent(Response resp, String calendarId, Calendar mService) {
        ...
        EventDateTime start = new EventDateTime()
                .setDateTime(Functions.dateFormatGCalendar(resp.getBIRTHDATE(), 10, 00))//10AM time to start
                .setTimeZone(TimeZone.getDefault().getID());
        event.setStart(start);

        EventDateTime end = new EventDateTime()
                .setDateTime(Functions.dateFormatGCalendar(resp.getBIRTHDATE(), 10, 11))//10AM time to end
                .setTimeZone(TimeZone.getDefault().getID());
        event.setEnd(end);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        public MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.calendar.Calendar.Builder(
                    ...
                    .build();
            mProgress = new ProgressDialog(GoogleCalendar.this, ProgressDialog.THEME_DEVICE_DEFAULT_LIGHT);
        }
