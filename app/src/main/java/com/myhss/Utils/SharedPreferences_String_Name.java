...
public class SharedPreferences_String_Name {

	public static String API_KEY = "API_KEY";
	public static String SW_BackBtn_FlaG = "SW_BackBtn_FlaG";
	public static String API_POSSCODE = "API_POSSCODE";
	public static String DEVICE_ID = "DEVICE_ID";
	public static String DEVICE_FCM = "DEVICE_FCM";
	public static String DEVICE_FACEID = "DEVICE_FACEID";
	public static String DEVICE_FINGERID = "DEVICE_FINGERID";
	...
	public static String SessionFlag = "SessionFlaG";
	public static String Allow_notification = "Allow_notification";
	public static String SET_REMINDER = "SET_REMINDER";
	public static String SET_POST_REMINDER = "SET_POST_REMINDER";
	public static String Set_reminder = "Set_reminder";
	public static String Dehydration_notification = "Dehydration_notification";
	public static String Postexcercise_notification = "Postexcercise_notification";
	public static String Email = "Email";
	public static String Strip_BatchId = "Strip_BatchId";
	public static String UserId = "UserId";
	public static String UserName = "UserName";
	public static String UserImage = "UserImage";
	public static String Device_ID = "Device_ID";
	public static String Strip_first = "Strip_first";
	public static String Strip_second = "Strip_second";
	public static String STRIP_SIZE = "STRIP_SIZE";
	public static String OLD_PACKET = "OLD_PACKET";
	public static String ISNEWATHLETE = "ISNEWATHLETE";
	...
	public static String DASHBOARD = "DASHBOARD";
	public static String SUBCHILD = "SUBCHILD";
	public static String REPORTVIEW = "REPORTVIEW";
	public static String SUBREPORTVIEW = "SUBREPORTVIEW";

//	public static String BLE_NAME = "BLE_NAME";
//	public static String BLE_MACID = "BLE_MACID";
//	public static String BLE_STATUS = "BLE_STATUS";

//	public static String Finger_Print_Access = "Finger_Print_Access";
	public static ArrayList<String> Stripdata = new ArrayList<>();
	...
	public static String[] badwordsArray = new String[] { "4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e",
			"arrse", "arse", "ass", "ass-fucker", "asses", "assfucker", "assfukka", "asshole", "assholes", "asswhole",
			"a_s_s", "b!tch", "b00bs", "b17ch", "b1tch", "ballbag", "balls", "ballsack", "bastard", "beastial",
			"beastiality", "bellend", "bestial", "bestiality", "bi+ch", "biatch", "bitch", "bitcher", "bitchers",
			"bitches", "bitchin", "bitching", "bloody", "blow job", "blowjob", "blowjobs", "boiolas", "bollock",
			"bollok", "boner", "boob", "boobs", "booobs", "boooobs", "booooobs", "booooooobs", "breasts", "buceta",
			...
			"fecker", "felching", "fellate", "fellatio", "fingerfuck", "fingerfucked", "fingerfucker", "fingerfuckers",
			...
			"shitting", "shittings", "shitty", "skank", "slut", "sluts", "smegma", "smut", "snatch", "son-of-a-bitch",
			"spac", "spunk", "s_h_i_t", "t1tt1e5", "t1tties", "teets", "teez", "testical", "testicle", "tit", "titfuck",
			"tits", "titt", "tittie5", "tittiefucker", "titties", "tittyfuck", "tittywank", "titwank", "tosser", "turd",
